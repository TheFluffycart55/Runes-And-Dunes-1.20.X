...
public class EclipsalRelicItem extends Item
{
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.dunes_mod.eclipsal_relic.tooltip.shift"));

        }

        else {
            pTooltipComponents.add(Component.translatable("tooltip.dunes_mod.eclipsal_relic.tooltip"));
        }
    }
}