...
public class DustParticles extends TextureSheetParticle {
    protected DustParticles(ClientLevel pLevel, double pX, double pY, double pZ,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double pX, double pY, double pZ,
            ...
            return new DustParticles(level, pX, pY, pZ, this.spriteSet, pXSpeed, pYSpeed, pZSpeed);
        }
    }
}
